...
RAW_NAME="${DIT_RAW_NAME:-bar_handoff_jointpos_scripted_success${EPISODES}_${STAMP}}"
...
TRAIN_PROFILE="${DIT_TRAIN_PROFILE:-/home/qsh/dit/configs/train/bar_handoff_state26_absjoint18_2gpu_bs16_accum4.json}"
...
bash /home/qsh/dit/scripts/train/train_bar_handoff_state26_absjoint18_mtdp.sh \
  "${LEROBOT_DIR}" \
