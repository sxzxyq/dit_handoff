"""Subprocess LeRobot policy worker for pose14 closed-loop evaluation."""
...
from dit_handoff.constants import CAMERA_OBS_FEATURES, LANGUAGE_INSTRUCTION
from dit_handoff.eval.closed_loop_handoff_state26_relee_pose14 import _load_policy_stack, _repeat_obs_window
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="LeRobot pose14 policy subprocess worker.")
    ...
    for line in sys.stdin:
        ...
        try:
            ...
            chunk = _action_chunk_from_npz(
                ...
                request.get("language") or LANGUAGE_INSTRUCTION,
            )
