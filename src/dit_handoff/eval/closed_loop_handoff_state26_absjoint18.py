"""Closed-loop state26 -> absjoint18 evaluation in the Joint-Pos handoff env."""
    ...
    def __init__(self, checkpoint: Path, policy_python: str, device: str, out_dir: Path):
        ...
        self.proc = subprocess.Popen(
            [
                policy_python,
                "-m",
                "dit_handoff.eval.policy_worker_handoff_state26_absjoint18",
                "--checkpoint",
                str(checkpoint),
                "--device",
                device,
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Closed-loop eval for state26 -> absjoint18.")
    try:
        from isaaclab.app import AppLauncher
