"""Raw collector for rectangular-bar aerial handoff absjoint18 data.
...
def _observation_snapshot(env: Any, obs: Any, episode_dir: Path, step_index: int, fps: float, *, save_images: bool) -> dict[str, Any]:
    ...
    snapshot = {
        ...
        "bar": _object_snapshot(env, "object"),
...
def collect(args: argparse.Namespace) -> Path:
    ...
    manifest = raw_dataset_manifest(
        ...
        extra={
            "task_name": "bar_handoff_dual_franka_joint_pos",
            "language_instruction": BAR_HANDOFF_LANGUAGE_INSTRUCTION,
            "expert": args.expert,
            "object_type": "rectangular_bar",
            "bar_size_xyz_m": [0.04, 0.04, 0.22],
            "handoff_style": "aerial_two_end_transfer",
    ...
    try:
        ...
        while kept_episodes < args.episodes:
            ...
            meta["task_name"] = "bar_handoff_dual_franka_joint_pos"
            meta["language_instruction"] = BAR_HANDOFF_LANGUAGE_INSTRUCTION
            meta["object_type"] = "rectangular_bar"
            meta["bar_size_xyz_m"] = [0.04, 0.04, 0.22]
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Collect raw rectangular-bar handoff absjoint18 data.")
    try:
        from isaaclab.app import AppLauncher
    ...
    parser.add_argument("--dataset-name", default="bar_handoff_jointpos_raw_smoke")
    parser.add_argument("--task", default=BAR_HANDOFF_JOINT_POS_TASK_ID)
    parser.add_argument("--expert", default="dit_handoff.collect.bar_handoff_experts:scripted_bar_handoff_jointpos_action")
